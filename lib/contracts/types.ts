...
export type Schedule={latestOccurrence?:ScheduleOccurrence|null;id:string;name:string;startDate:string;localTime:string;timezone:string;repeatDays:number;prompt:string;deviceSerial:string;logDirectory:string;status:ScheduleStatus;nextRunAt:string|null;completedOccurrences:number;createdAt:string;updatedAt:string};
